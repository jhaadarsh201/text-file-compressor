...
#include "lzw.h" // Iss lzw.h me aur bhi files indirectly include ho gaye hai-> lzw.h >> bitstream.cpp>> bitsream.h>> dictionary.h
namespace lzw 
{
// ================================================================================================
//
                ...
                uint8_t ** compressed, int * compressedSizeBytes, int * compressedSizeBits)
{
    ...
    int code = Nil;
    int codeBitsWidth = StartBits;  //ye start bits kaha se aaya????????
    ...
    for (; uncompressedSizeBytes > 0; --uncompressedSizeBytes, ++uncompressed) //uncompressed to str0 wala pointer tha jo uncompressed file ke starting ko point karta hai
    {
